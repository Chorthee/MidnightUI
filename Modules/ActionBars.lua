...
function AB:UpdateButtonElements(btn)
    ...
    -- Fix pushed texture - expand 2px beyond button to ensure full coverage
    ...
    -- Fix flash texture - expand 2px beyond button
    if btn.Flash then
    ...
    -- Fix checked texture - expand 2px beyond button
