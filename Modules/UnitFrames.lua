        ...
        MigrateInfoBarText(defaults.targettarget)
                ...
                local function CreateUnitFrame(self, key, unit, anchor, anchorTo, anchorPoint, x, y)
                    ...
                    if Movable and (key == "PlayerFrame" or key == "TargetFrame" or key == "TargetTargetFrame" or key == "FocusFrame") then
                        ...
                        frame.movableHighlight:SetColorTexture(0, 0.5, 1, 0.5) -- semi-transparent bright blue for debug
                        -- Add a white border for debug
                        ...
                        frame.movableHighlightBorder:SetColorTexture(1, 1, 1, 0.8)
                        frame.movableHighlightFrame:Show() -- Always show for debug
