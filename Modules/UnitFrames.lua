    ...
    return {
        ...
        args = {
            ...
            spacing = {
                ...
                set = function(_, v) self.db.profile.spacing = v; if self.UpdateUnitFrame then self:UpdateUnitFrame('PlayerFrame', 'player') end end
            },
            position = {
            ...
            health = {
                ...
                args = {
                    ...
                    height = { type = "range", name = "Height", min = 8, max = 60, step = 1, order = 2,
                        ...
                        set = function(_, v) self.db.profile.health.height = v; if self.UpdateUnitFrame then self:UpdateUnitFrame('PlayerFrame', 'player') end end },
                    color = colorOpt("Bar Color", nil,
                        function() return unpack(self.db.profile.health.color) end,
                        function(_,r,g,b,a) self.db.profile.health.color = {r,g,b,a}; if self.UpdateUnitFrame then self:UpdateUnitFrame('PlayerFrame', 'player') end end, 3),
                    bgColor = colorOpt("Background Color", nil,
                        function() return unpack(self.db.profile.health.bgColor) end,
                        function(_,r,g,b,a) self.db.profile.health.bgColor = {r,g,b,a}; if self.UpdateUnitFrame then self:UpdateUnitFrame('PlayerFrame', 'player') end end, 4),
                    font = fontOpt("Font",
                        function() return self.db.profile.health.font end,
                        function(_,v) self.db.profile.health.font = v; if self.UpdateUnitFrame then self:UpdateUnitFrame('PlayerFrame', 'player') end end, 5),
                    fontSize = { type = "range", name = "Font Size", min = 8, max = 32, step = 1, order = 6,
                        get = function() return self.db.profile.health.fontSize end,
                        set = function(_,v) self.db.profile.health.fontSize = v; if self.UpdateUnitFrame then self:UpdateUnitFrame('PlayerFrame', 'player') end end },
                    fontOutline = { type = "select", name = "Font Outline", order = 7,
                        ...
                        set = function(_,v) self.db.profile.health.fontOutline = v; if self.UpdateUnitFrame then self:UpdateUnitFrame('PlayerFrame', 'player') end end },
                    fontColor = colorOpt("Font Color", nil,
                        function() return unpack(self.db.profile.health.fontColor) end,
                        function(_,r,g,b,a) self.db.profile.health.fontColor = {r,g,b,a}; if self.UpdateUnitFrame then self:UpdateUnitFrame('PlayerFrame', 'player') end end, 8),
                    text = { type = "input", name = "Text Format", order = 9,
                        get = function() return self.db.profile.health.text end,
                        set = function(_,v) self.db.profile.health.text = v; if self.UpdateUnitFrame then self:UpdateUnitFrame('PlayerFrame', 'player') end end },
                    textPos = { type = "select", name = "Text Position", order = 10,
                        values = {LEFT="LEFT",CENTER="CENTER",RIGHT="RIGHT"},
                        get = function() return self.db.profile.health.textPos end,
                        set = function(_,v) self.db.profile.health.textPos = v; if self.UpdateUnitFrame then self:UpdateUnitFrame('PlayerFrame', 'player') end end },
                    texture = texOpt("Bar Texture",
                        function() return self.db.profile.health.texture end,
                        function(_,v) self.db.profile.health.texture = v; if self.UpdateUnitFrame then self:UpdateUnitFrame('PlayerFrame', 'player') end end, 11),
                }
            },
            power = {
                name = "Power Bar",
                ...
                args = {
                    ...
                    height = { type = "range", name = "Height", min = 8, max = 60, step = 1, order = 2,
                        ...
                        set = function(_, v) self.db.profile.power.height = v; if self.UpdateUnitFrame then self:UpdateUnitFrame('PlayerFrame', 'player') end end },
                    color = colorOpt("Bar Color", nil,
                        function() return unpack(self.db.profile.power.color) end,
                        function(_,r,g,b,a) self.db.profile.power.color = {r,g,b,a}; if self.UpdateUnitFrame then self:UpdateUnitFrame('PlayerFrame', 'player') end end, 3),
                    bgColor = colorOpt("Background Color", nil,
                        function() return unpack(self.db.profile.power.bgColor) end,
                        function(_,r,g,b,a) self.db.profile.power.bgColor = {r,g,b,a}; if self.UpdateUnitFrame then self:UpdateUnitFrame('PlayerFrame', 'player') end end, 4),
                    font = fontOpt("Font",
                        function() return self.db.profile.power.font end,
                        function(_,v) self.db.profile.power.font = v; if self.UpdateUnitFrame then self:UpdateUnitFrame('PlayerFrame', 'player') end end, 5),
                    fontSize = { type = "range", name = "Font Size", min = 8, max = 32, step = 1, order = 6,
                        get = function() return self.db.profile.power.fontSize end,
                        set = function(_,v) self.db.profile.power.fontSize = v; if self.UpdateUnitFrame then self:UpdateUnitFrame('PlayerFrame', 'player') end end },
                    fontOutline = { type = "select", name = "Font Outline", order = 7,
                        values = {NONE="NONE",OUTLINE="OUTLINE",THICKOUTLINE="THICKOUTLINE"},
