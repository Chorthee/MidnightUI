...
function UnitFrames:GetFocusOptions_Real()
	...
	local function update()
		...
		if self and self.CreateFocusFrame then self:CreateFocusFrame() end
	end
	return {
		type = "group",
		name = "Focus Frame",
		args = {
			header = { type = "header", name = "Focus Frame Bars", order = 0 },
			spacing = {
				type = "range",
				name = "Bar Spacing",
			...
			health = {
				...
				args = {
					...
					classColor = {
						...
						desc = "Use class color for the health bar.",
						order = 3.9,
					...
					fontClassColor = {
						...
						desc = "Use class color for the health bar text.",
						order = 9.5,
			...
			power = {
				...
				args = {
					...
					classColor = {
						type = "toggle",
						name = "Class Colored Bar",
						desc = "Use class color for the power bar.",
						order = 3.9,
					...
					fontClassColor = {
						type = "toggle",
						name = "Class Colored Font",
						desc = "Use class color for the power bar text.",
						order = 9.5,
			...
			info = {
				...
				args = {
					...
					classColor = {
						type = "toggle",
						name = "Class Colored Bar",
						desc = "Use class color for the info bar.",
						order = 3.9,
					...
					fontClassColor = {
						type = "toggle",
						name = "Class Colored Font",
						desc = "Use class color for the info bar text.",
						order = 9.5,
