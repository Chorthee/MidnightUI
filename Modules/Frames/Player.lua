        ...
        args = {
            ...
            info = {
                ...
                args = {
                    ...
                    alpha = { type = "range", name = "Bar Transparency", desc = "Set the transparency of the info bar.", min = 0, max = 1, step = 0.01, order = 4.1, get = function() return db.info and db.info.alpha or (db.info and db.info.color and db.info.color[4]) or 1 end, set = function(_, v) db.info.alpha = v; if db.info and db.info.color then db.info.color[4] = v; end; update() end },
